...
scripts/check/run.sh static || exit 1
scripts/check/run.sh build  || exit 1
scripts/check/run.sh output || exit 1
scripts/check/run.sh release || exit 1

./c snapshot
git add conformance/snapshots
