...
description = 'The fixture page for the reading-time feature, which turns the switch on so that what the manifest declares can be seen.'
[params.features]
  reading-time = true
+++

This page exercises the reading-time feature. The switch above turns it on,
